...
The eight existing tool schemas and initialization instructions live in
...
- Installed Codex 0.154.0: the opt-in probe passed against the real Rust broker
  and discovered exactly the eight Monitter tools. It used temporary settings
