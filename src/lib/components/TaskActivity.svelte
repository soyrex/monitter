...
<style>
  ...
  .task-activity.docked { position:relative; z-index:0; width:min(calc(var(--chat-content-max-width,900px) - 40px),calc(100% - 60px)); box-sizing:border-box; margin:0 auto -10px; }
