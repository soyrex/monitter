...
class MCPTests(unittest.TestCase):
    ...
    def test_handshake_list_forward_and_error(self):
        ...
        try:
            ...
            self.assertEqual({tool["name"] for tool in listing["result"]["tools"]}, {"list_agents","delegate_task","send_message","get_task_result","wait_for_task","list_messages","cancel_delegation"})
