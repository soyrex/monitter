...
try {
 ...
 await page.goto('http://127.0.0.1:18433');await expect(page.getByRole('button',{name:'Standard view',exact:true})).toBeEnabled({timeout:60000});await page.getByRole('complementary',{name:'Agents and tasks'}).getByRole('button',{name:/Team/}).click();
