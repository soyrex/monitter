...
const extraCss = ':root { --density-control-size:30px; --density-tabbar-inset:0px; --line:#ccc; } button { box-sizing:border-box; padding:0; border:0; } .workspace { width:320px; } .embedded .topbar { box-sizing:border-box; padding:.5em .5em 0; } .workspace-context { display:grid; place-items:center; flex:none; width:30px; padding-bottom:.5em; } .workspace-context .avatar { display:block; width:24px; height:24px; } .top-actions { display:flex; align-items:center; gap:14px; flex-shrink:0; padding-bottom:.5em; } .tabs { display:flex; flex:1; min-width:0; } .tab-picker-trigger { display:flex; align-items:center; justify-content:space-between; width:100%; padding:0 8px; border:1px solid #bbb; } .workspace.compact-tabs > .topbar { padding-block:.5em; } .workspace.compact-tabs > .topbar > .workspace-context, .workspace.compact-tabs > .topbar > .top-actions { padding-bottom:0; } .mobile-navigation .workspace > .topbar { height:52px; box-sizing:border-box; align-items:center; padding:4px; gap:4px; } .mobile-navigation .topbar > .tabs { align-self:stretch; } .mobile-navigation .topbar > .top-actions { padding:0; gap:0; } .mobile-navigation .top-actions > .icon { width:44px; height:44px; } .mobile-navigation .workspace.compact-tabs > .topbar { padding-block:4px; }';
