...
try {
 ...
 await page.getByRole('button',{name:'Open terminal',exact:true}).click();await expect(page.locator('.terminal-pane .xterm-helper-textarea')).toBeAttached({timeout:20000});await page.locator('.terminal-pane .xterm-helper-textarea').focus();await page.keyboard.press('Control+d');
